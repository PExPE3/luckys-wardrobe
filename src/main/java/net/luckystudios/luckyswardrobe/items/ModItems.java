...
//            () -> new DyeableOutfitArmorItem(new Item.Properties().component(ModDataComponents.OPENED, false)));
//    public static final DeferredItem<DyeableOutfitArmorItem> TAIGA_COAT = ITEMS.register("taiga_coat",
//            () -> new DyeableOutfitArmorItem( new Item.Properties()));
...
//            () -> new DyeableHoodArmorItem( new Item.Properties().component(ModDataComponents.OPENED, false)));
...
//            () -> new OutfitArmorItem(ModArmorMaterials.DYEABLE_LEATHER_COSMETIC, ArmorItem.Type.HELMET, new Item.Properties()));
//    public static final DeferredItem<OutfitArmorItem> SAVANNA_ROBE = ITEMS.register("savanna_robe",
//            () -> new OutfitArmorItem(ModArmorMaterials.DYEABLE_LEATHER_COSMETIC, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
//    public static final DeferredItem<OutfitArmorItem> SAVANNA_PANTS = ITEMS.register("savanna_pants",
//            () -> new OutfitArmorItem(ModArmorMaterials.DYEABLE_LEATHER_COSMETIC, ArmorItem.Type.LEGGINGS, new Item.Properties()));
//    public static final DeferredItem<OutfitArmorItem> SAVANNA_SANDALS = ITEMS.register("savanna_sandals",
//            () -> new OutfitArmorItem(ModArmorMaterials.DYEABLE_LEATHER_COSMETIC, ArmorItem.Type.BOOTS, new Item.Properties()));
//
...
//            () -> new DyeableCosmeticArmorItem(new Item.Properties()));
//
//    public static final DeferredItem<DyeableCosmeticArmorItem> FARMER_HAT = ITEMS.register("farmer_hat",
//            () -> new DyeableCosmeticArmorItem(new Item.Properties()));

    public static final DeferredItem<AccessoryItem> HAT = ITEMS.register("hat",
...
//            () -> new CosmeticArmorItem(new Item.Properties()));
//
...
//            () -> new CosmeticArmorItem(new Item.Properties()));
//
//    public static final DeferredItem<CosmeticArmorItem> NEWSBOY_HAT = ITEMS.register("newsboy_hat",
//            () -> new CosmeticArmorItem(new Item.Properties()));
//
//    public static final DeferredItem<DyeableCosmeticArmorItem> CHEF_HAT = ITEMS.register("chef_hat",
//            () -> new DyeableCosmeticArmorItem(new Item.Properties()));
//
