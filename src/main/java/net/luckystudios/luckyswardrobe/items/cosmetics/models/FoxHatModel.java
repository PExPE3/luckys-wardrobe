...
public class FoxHatModel<T extends LivingEntity> extends HumanoidArmorModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(LuckysWardrobe.MOD_ID, "fox_hat"), "main");
	private final ModelPart head;
	private final ModelPart swingPart;

	public FoxHatModel(ModelPart root) {
        super(root);
